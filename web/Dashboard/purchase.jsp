...
<div class="wrapper">
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <% } %>
            <form action="PurchaseDashboardServlet" method="post">
                <input type="text" name="productId" placeholder="Product ID" required>
                <input type="number" name="quantity" placeholder="Quantity" required>
                <button type="submit" name="action" value="addPurchase">Add Purchase</button>
            </form>
        </section>
    </div>

    <footer class="main-footer">
        <strong>Copyright &copy; 2016-2017 <a href="#">Optimus Prime</a>.</strong> The Group
<%--<%--%>
<%--    if ((session.getAttribute("userid") == null) || (session.getAttribute("userid") == "")) {--%>
<%--%>--%>
<%--<h1>You are not logged in</h1><br/>--%>
