            ...
            <main>
                <div class="panel panel-primary">
                    <div class="container">
                        ...
                        <form class="col-xs-12 col-sm-6 col-md-4 col-sm-offset-3 col-md-offset-4" action="EditDealerServlet" method="post">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<%= u.getDealer_id() %>" name="dealer_id" placeholder="Enter Quantity">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<%= u.getContact() %>" name="contact" placeholder="Enter Contact">
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="address" placeholder=""><%= u.getAddress() %></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="agent_name" placeholder=""><%= u.getAgent_name() %></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="agent_contact" placeholder=""><%= u.getAgent_contact() %></textarea>
                                        </div>
                                    </td>
                                </tr>
                                <tr>
