            ...
            <main>
                <div class="panel panel-primary">
                    <div class="container">
                        ...
                        <form class="form-inline" action="EditMemberServlet" method="post">
                                ...
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="member_id" value="<%= u.getMember_id() %>" class="form-control" placeholder="Enter Your Id">
                                        </div><br>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <label for="name">Name</label><br>
                                            <input type="text" name="name" value="<%= u.getName() %>" class="form-control" placeholder="Enter Name ">
                                        </div><br>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="password" value="<%= u.getPassword() %>" class="form-control" placeholder="Enter Password">
                                        </div><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" value="<%= u.getEmail() %>" class="form-control" placeholder="Enter email">
                                        </div><br>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <label for="mobile">Mobile No.</label><br>
                                            <input type="text" name="mobile_no" value="<%= u.getMobile_no() %>" class="form-control" placeholder="Enter Mobile No">
                                        </div><br>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <label for="">NID</label><br>
                                            <input type="text" name="nid" value="<%= u.getNid() %>" class="form-control" placeholder="Enter National Id">
                                        </div><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="pre_address" rows="4"><%= u.getPre_address() %></textarea>
                                        </div><br>
                                    </td>
                                    <td>
                                        <div class="form-group">
                                            <label for="address">Permanent Address</label><br>
                                            <textarea class="form-control" name="per_address" rows="4"><%= u.getPer_address() %></textarea>
                                        </div><br>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="payment" value="<%= u.getPayment() %>" class="form-control" placeholder="Enter Payment">
                                        </div><br>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            ...
                                            <input type="date" name="date" value="<%= u.getDate() %>" class="form-control">
                                        </div><br>
                                    </td>
                                </tr>
                                <tr>
