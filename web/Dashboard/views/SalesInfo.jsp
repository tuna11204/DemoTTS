...
<%@ page import="yourpackage.SaleRecord" %>
...
<div class="container">
    ...
    <div class="form-group">
        ...
        <input type="date" class="form-control" id="searchDate" name="pdate">
    </div>
    <table class="table table-striped">
        ...
        <c:forEach var="record" items="${sales}">
            <tr>
                <td><c:out value="${record.slNo}"/></td>
                <td><c:out value="${record.date}"/></td>
                <td><c:out value="${record.category}"/></td>
                <td><c:out value="${record.productName}"/></td>
                <td><c:out value="${record.tagNumber}"/></td>
                <td><c:out value="${record.quantity}"/></td>
                <td><c:out value="${record.unit}"/></td>
                <td><c:out value="${record.perUnitPrice}"/></td>
                <td><c:out value="${record.totalPrice}"/></td>
                <td>
